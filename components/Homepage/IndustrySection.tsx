...
const EXTRA_PADDING = 48; // keep last card visible
...
> <div className="w-full flex flex-col gap-10 mx-auto sticky top-0 bg-[var(--secondary-bg)] py-14"> <AnimatedSection
       className="text-center max-w-[740px] mx-auto"
       delay={0.2}
       staggerDelay={0.3}
     > <span className="block text-product-label font-medium text-[var(--black)] mb-3">
• Our Product Range </span> <SplitText
