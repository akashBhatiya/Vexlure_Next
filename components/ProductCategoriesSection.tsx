    ...
    <section className="w-full py-20 px-4 md:px-8 flex flex-col items-center bg-[var(--white)]">
      ...
      <AnimatedSection className="max-w-[900px] md:w-full mx-auto mb-10">
        ...
        <SplitText 
          ...
          className="text-3xl md:text-5xl leading-[44px] md:leading-[64px] font-semibold text-[var(--black)] mb-2 md:mb-4 text-center"
        />
          ...
          if (idx === 0) {
            ...
            return (
              <AnimatedCardMobile key={cat.slug} index={idx} delay={0.2}>
                <Link href={`/product/${cat.slug}`} className="bg-white rounded-2xl overflow-hidden flex flex-col h-full group/card">
